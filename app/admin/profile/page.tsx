...
import { Mail, User, LogOut, ArrowLeft, ShieldAlert, Save, X, CheckCircle2, Pencil } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-foreground">Admin Profile</h1>
          <p className="text-sm text-muted">System administrator account settings</p>
        </div>
        <Button
          variant="ghost"
