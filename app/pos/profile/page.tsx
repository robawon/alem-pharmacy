...
import { Mail, User, LogOut, ArrowLeft, ShoppingCart, Save, X, CheckCircle2, Pencil } from "lucide-react";

export default function CashierProfilePage() {
  return (
    <AppShell requiredRole="cashier">
      <CashierProfileContent />
    </AppShell>
  );
}

function CashierProfileContent() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-foreground">Cashier Profile</h1>
          <p className="text-sm text-muted">Your Point of Sale account information</p>
        </div>
        <Button
          variant="ghost"
